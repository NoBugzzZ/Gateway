    ...
    def convert(self, config, data):
        ...
        try:
            ...
            if self.__config.get("udoi") is not None:
                dict_result["udoi"] = TBUtility.get_value(self.__config.get("udoi"), data, expression_instead_none=True)
            else:
            ...
            if self.__config.get("schemaId") is not None:
                dict_result["schemaId"] = TBUtility.get_value(self.__config.get("schemaId"), data, expression_instead_none=True)
            else:
