...
class TBGatewayMqttClient(TBDeviceMqttClient):
    ...
    def _on_decoded_message(self, content, message):
        # print("[TBGatewayMqttClient _on_decoded_message]",message.topic,content)
    ...
    def gw_send_payload(self, payload, quality_of_service=1):
        return self.publish_data(payload, "udo", quality_of_service)
